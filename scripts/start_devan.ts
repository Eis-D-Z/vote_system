...
const devanAddress = "0xece0fe8cfa4a902530687761636ced18e0aa4c6898db17bd84ec17cfb4a57033";
...
const voting = async () => {
  ...
  for (let kp of keypairs) {
    await singleVote(devanAddress, kp, address, keypair, client);
  }
  // ourVoter vote
//   await singleVote(
